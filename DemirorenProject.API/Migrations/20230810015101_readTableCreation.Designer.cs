...
namespace DemirorenProject.API.Migrations
{
    ...
    [Migration("20230810015101_readTableCreation")]
    partial class readTableCreation
    {
            ...
            modelBuilder.Entity("DemirorenProject.API.Entities.NewsEN", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2023, 8, 10, 4, 51, 1, 376, DateTimeKind.Local).AddTicks(5020),
                            NoOfViews = 0,
                            Title = "Test"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2023, 8, 10, 4, 51, 1, 376, DateTimeKind.Local).AddTicks(5032),
                            NoOfViews = 0,
                            Title = "Test2"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2023, 8, 10, 4, 51, 1, 376, DateTimeKind.Local).AddTicks(5033),
                            NoOfViews = 0,
                            Title = "Test3"
                        },
                        new
                        {
                            ...
                            Date = new DateTime(2023, 8, 10, 4, 51, 1, 376, DateTimeKind.Local).AddTicks(5034),
                            NoOfViews = 0,
                            Title = "Test4"
                        });
                });
